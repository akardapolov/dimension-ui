...
public class DBTypeIcon implements Icon {
  ...
  private static final Color ORACLE_COLOR = new Color(0xCF5F5F);
  private static final Color POSTGRES_COLOR = new Color(0x336791);
  private static final Color MSSQL_COLOR = new Color(0xCC2927);
  private static final Color CLICKHOUSE_COLOR = new Color(0xFFCC00);
