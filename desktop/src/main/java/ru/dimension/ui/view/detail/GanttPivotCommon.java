...
@Log4j2
public abstract class GanttPivotCommon extends JPanel {
  ...
  public GanttPivotCommon(TableInfo tableInfo,
                          CProfile cProfile,
                          long begin,
                          long end,
  ...
  protected String[][] createColumnNames(List<GanttColumnCount> ganttColumnList2) {
  ...
  protected void sortGanttColumns(List<GanttColumnCount> ganttColumnList) {
