...
@Log4j2
public class AnalyzeHistoryPanel extends JPanel implements IDetailPanel, CustomAction {
  ...
  public AnalyzeHistoryPanel(WorkspaceQueryComponent workspaceQueryComponent,
                             QueryInfo queryInfo,
                             TableInfo tableInfo,
                             ChartInfo chartInfo,
    ...
    this.workspaceQueryComponent.initAnalyzeHistory(new WorkspaceAnalyzeHistoryModule(this)).inject(this);
    ...
    AnalyzeComponent analyzeComponent =
        new AnalyzeComponent(eventListener, sqlQueryState, dStore, router,
                             queryInfo, tableInfo, chartInfo, profileTaskQueryKey, sourceConfig, AnalyzeType.HISTORY,
