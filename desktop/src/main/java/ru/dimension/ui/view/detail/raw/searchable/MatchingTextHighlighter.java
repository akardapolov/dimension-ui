 ...
 *
 */
package ru.dimension.ui.view.detail.raw.searchable;
 ...
 * characters that match a regular expression. The highlighting style can be configured with a {@link Painter}.
 * </p>
 * <p>
 * This highlighter is designed to work with a {@link SearchPredicate}. All other predicate types will be ignored and no
 * highlighting will be performed.
 * </p>
 *
 * <p>
 * <strong>NOTE: This highlighter is designed to work with renderers that both
 * extend {@link JLabel} and implements {@link PainterAware}. Other renderers will be left undecorated.</strong>
 * </p>
 *
 * @author gregtan
...
public class MatchingTextHighlighter extends AbstractHighlighter {
  ...
  /**
   * Instantiates a <code>MatchingTextHighlighter</code> with no highlight predicate or painter.
   */
  ...
  /**
   * Instantiates a <code>MatchingTextHighlighter</code> with no highlight predicate that paints with the specified
   * painter.
   *
  ...
  /**
   * <p>
   * Instantiates a <code>MatchingTextHighlighter</code> with the given predicate that matches text with the specified
   * pattern with the specified highlight color.
   * </p>
   *
  ...
  /**
   * Installs a listener to the painter if appropriate. This implementation registers its painterListener if the Painter
   * is of type AbstractPainter.
   */
  ...
  /**
   * Uninstalls a listener from the painter if appropriate. This implementation removes its painterListener if the
  ...
  /**
   * Lazily creates and returns the property change listener used to listen to changes of the painter.
   *
   * @return the property change listener used to listen to changes of the painter.
   */
   ...
   * <p>
   * <p>
   * This implementation fires a stateChanged on receiving any propertyChange, if the isAdjusting flag is false.
  ...
  /**
   * Finds the rectangles that contain rendered characters that match the pattern.
   *
   * @param object an optional configuration parameter. This may be null.
   * @param width  width of the area to paint.
   * @param height height of the area to paint.
   * @return a <code>List</code> of <code>Rectangle</code>s marking characters to highlight
   */
  protected List<Rectangle> findHighlightAreas(JLabel object,
                                               int width,
                                               int height) {
   ...
   * </p>
   *
   * @param fullText    useful for highlighting if matches exist in clipped text and in the ellipsis
   * @param clippedText the clipped text to search (could be the same as fullText)
   * @param fm          the font metrics of the rendered font
   * @param xOffset     the x offset at which text rendering starts
   * @param yOffset     the y offset at which text rendering starts (e.g. different rowHeights)
  ...
  /**
   * Joins highlight rectangles that mark adjacent horizontal areas into single rectangles. This is useful to renderers
   * that vary horizontally, such a horizontal gradient - the gradient will not restart when there are two adjacent
   * highlight areas.
   *
   ...
   */
  protected int calculateXOffset(JLabel component,
                                 Rectangle viewR,
                                 Rectangle textR,
                                 Rectangle iconR,
                                 int iconTextGap) {
