...
@Log4j2
public class RawDataDashboardPanel extends RawDataPanelCommon {

  private final DStore dStore;

  public RawDataDashboardPanel(DStore dStore,
                               TableInfo tableInfo,
                               CProfile cProfile,
                               long begin,
                               long end,
  ...
  @Override
  protected void loadResultSet(String tableName, long begin, long end) {
    if (useFetchSize) {
  ...
  @Override
  protected void loadRawData(String tableName, long begin, long end) {
