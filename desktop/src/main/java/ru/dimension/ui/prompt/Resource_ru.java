...
public class Resource_ru extends ListResourceBundle {
  ...
  private static final Object[][]
      prtText =
      {
          ...
          {"qSqlText", "Текст SQl"},
          {"mTableName", "Имя таблицы"},
          {"mTableType", "Тип таблицы"},
          {"mTableIndex", "Тип индекса таблицы"},
          {"mTimestamp", "Метка времени таблицы"},
          ...
          {"sysErrMsg", "Системная ошибка, смотрите журнал сообщений приложения"},
      };
