...
public final class Arima {
   ...
   * @param forecastSize integer representing how many data points AFTER the data series to be forecasted
   * @param params       ARIMA parameters
   * @return a ForecastResult object, which contains the forecasted values and/or error message(s)
   */
  public static ForecastResult forecast_arima(final double[] data,
