...
public final class HannanRissanen {
  ...
  /**
   * Estimate ARMA(p,q) parameters, i.e. AR-parameters: \phi_1, ... , \phi_p MA-parameters: \theta_1, ... , \theta_q
   ...
   */
  public static void estimateARMA(final double[] data_orig,
                                  final ArimaParams params,
                                  final int forecast_length,
  ...
  private static double[] applyYuleWalkerAndGetInitialErrors(final double[] data,
                                                             final int r,
                                                             final int length,
                                                             final double[] errors) {
