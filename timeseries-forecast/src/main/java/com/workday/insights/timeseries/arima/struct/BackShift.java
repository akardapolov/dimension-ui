...
public final class BackShift {
  ...
  public BackShift(boolean[] indices,
                   boolean copyIndices) {
    if (indices == null) {
  ...
  public void setParam(final int paramIndex,
  ...
  public double getLinearCombinationFrom(double[] timeseries,
                                         int tsOffset) {
    double linearSum = 0;
    for (int j = 0; j < _offsets.length; ++j) {
