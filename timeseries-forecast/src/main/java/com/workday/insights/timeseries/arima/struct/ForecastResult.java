...
public class ForecastResult {
   ...
   */
  public ForecastResult(final double[] pForecast,
                        final double pDataVariance) {
   ...
   * @return Max Normalized Variance
   */
  public double setConfInterval(final double constant,
                                final double[] cumulativeSumOfMA) {
