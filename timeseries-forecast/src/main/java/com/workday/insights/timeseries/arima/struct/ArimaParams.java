...
public final class ArimaParams {
   ...
   */
  public double forecastOnePointARMA(final double[] data,
                                     final double[] errors,
                                     final int index) {
   ...
   * <p>
   * It is assumed that the input vector has _np + _nq entries first _np entries are AR-parameters and the last _nq
   * entries are MA-parameters
   *
