...
public final class ArimaSolver {
   ...
   */
  public static double[] forecastARMA(final ArimaParams params,
   ...
   */
  public static ForecastResult forecastARIMA(final ArimaParams params,
                                             final double[] data,
                                             final int forecastStartIndex,
                                             final int forecastEndIndex) {
   ...
   */
  public static ArimaModel estimateARIMA(final ArimaParams params,
                                         final double[] data,
                                         final int forecastStartIndex,
                                         final int forecastEndIndex) {
   ...
   */
  private static double[] differentiate(ArimaParams params,
                                        double[] trainingData,
   ...
   */
  private static double[] integrate(ArimaParams params,
                                    double[] dataForecastStationary,
                                    boolean hasSeasonalI,
                                    boolean hasNonSeasonalI) {
   ...
   * @param leftIndexOffset the number of elements from @param startIndex to the index which evaluation begins
   * @return Root Mean-Squared Error
   */
  public static double computeRMSE(final double[] left,
                                   final double[] right,
  ...
  /**
   * Performs validation using Root Mean-Squared Error given a time series (with forecast) and true values
   *
  ...
  public static double computeRMSEValidation(final double[] data,
                                             final double testDataPercentage,
                                             ArimaParams params) {
   ...
   */
  private static boolean checkARIMADataLength(ArimaParams params,
                                              double[] data,
                                              int startIndex,
                                              int endIndex) {
    boolean result = true;
