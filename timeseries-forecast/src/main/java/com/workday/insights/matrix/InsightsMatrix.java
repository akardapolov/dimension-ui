...
public class InsightsMatrix implements Serializable {
   ...
   * @param makeDeepCopy if TRUE, allocated new memory space and copy data over if FALSE, re-use the given memory space
   *                     and overwrites on it
   */
  public InsightsMatrix(double[][] data,
   ...
   * @return TRUE, matrix is in valid format FALSE, matrix is not in valid format
   */
   ...
   */
  public InsightsVector solveSPDIntoVector(InsightsVector b,
                                           final double maxConditionNumber) {
