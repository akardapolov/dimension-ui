...
public class InsightsVector implements Serializable {
   ...
   * @param deepCopy if TRUE, allocated new memory space and copy data over if FALSE, re-use the given memory space and
   *                 overwrites on it
   */
  public InsightsVector(double[] data,
                        boolean deepCopy) {
