...
public class ArimaTest {
  ...
  private double[] commonTestLogic(final String name,
  ...
  private double forecastSinglePointLogic(final String name,
                                          final double[] dataSet,
                                          int p,
                                          int d,
                                          int q,
  ...
  private double[] commonTestSimpleForecast(final String name,
                                            final double[] trainingData,
                                            final double[] trueForecastData,
  ...
  private double commonTestCalculateRMSE(final String name,
                                         final double[] trainingData,
                                         final double[] trueForecastData,
                                         final int forecastSize,
                                         int p,
