...
public class JTableRendererAdapter implements TableCellRenderer {
    ...
    protected final DefaultTableCellRenderer defaultRenderer = new CustomCellRenderer();

    protected final LocalRenderer localRenderer = new LocalRenderer();

    public JTableRendererAdapter(CellRenderer renderer, boolean editor, boolean header) {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
...

        {
            ...
            state = new BasicCellState(table, value, isSelected, hasFocus, row, column, bounds);
        }
